...
@section('title','Деактивирани коли')
@section('content')
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            <a href="{{route('backend.carList')}}" class="btn btn-success float-lg-right">Активни коли</a>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="table_1" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->isElectric==1 ? "Автоматична" : "Ръчна"}}</td>
                            <td>{{$item->dailyPrice}}</td>
                            <td><a href="{{route('backend.carActive',['id' => $item->id])}}" class="btn btn-warning">Активирай</a></td>
                        </tr>
                        @endforeach
